...
[assembly: Dependency(typeof(B4.EE.RodriguezA.Droid.Services.AlarmService))]
...
namespace B4.EE.RodriguezA.Droid.Services
{
     public class AlarmService :IAlarmService
    {
        ...
        public Task<bool> CheckIfAlarmAlreadyExistAsync(string id)
        {
            ...
            var cursor = Android.App.Application.Context.ContentResolver.Query(alarmUri.Build(), eventProjection, null, null);
            if (cursor.Count == 0)
                tcs.SetResult(false);
            else
                tcs.SetResult(true);
        ...
        public Task<string> CreateAlarmAsync(string title, string description, DateTime timeInit, DateTime timeEnd, int alarmMinutes)
        {
            ...
            else
            {
                ...
                uri = Android.App.Application.Context.ContentResolver.Insert(CalendarContract.Reminders.ContentUri, reminderValues);
        ...
        public Task<bool> DeleteAlarmAsync(string id)
        {
            ...
            int rows = Android.App.Application.Context.ContentResolver.Delete(deleteUri.Build(), null, null);
            if (rows == 0)
                tcs.SetResult(false);
            else
                tcs.SetResult(true);
        ...
        private void GetSystemCalendar()
        {
            ...
            var loader = new Android.Support.V4.Content.CursorLoader(Android.App.Application.Context, calendarsUri, calendarsProjection, null, null, null);
        ...
        {
            return (ContextCompat.CheckSelfPermission(Android.App.Application.Context, Manifest.Permission.WriteCalendar) == Permission.Granted) &&
                   (ContextCompat.CheckSelfPermission(Android.App.Application.Context, Manifest.Permission.ReadCalendar) == Permission.Granted);
        }
     }
